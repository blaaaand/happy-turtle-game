...
pygame.display.set_caption("Simple Turtle")
...
class Jellyfish:
    ...
    def draw(self, screen):
        # Draw jellyfish
        pygame.draw.ellipse(screen, light_blue, self.rect)
        # Draw tentacles
        for i in range(5):
...
class Coral:
    ...
    def draw(self, screen):
        ...
        for circle in self.circles:
            pygame.draw.circle(screen, light_purple, circle.center, 15)
            # Add texture
    ...
    def draw(self, screen):
        ...
        pygame.draw.circle(screen, (0, 255, 0), (self.rect.x + 60, self.rect.y + 5), 10)
        pygame.draw.circle(screen, (255, 255, 255), (self.rect.x + 60, self.rect.y + 5), 3)
        pygame.draw.circle(screen, (0, 0, 0), (self.rect.x + 60, self.rect.y + 5), 1)
        
        # Draw shell (top layer)
        pygame.draw.ellipse(screen, (100, 60, 0), (self.rect.x - 5, self.rect.y - 15, 60, 30))
        
        # Draw legs (top layer)
        pygame.draw.circle(screen, (0, 255, 0), (self.rect.x + 15, self.rect.y + 15), 6)
        pygame.draw.circle(screen, (0, 255, 0), (self.rect.x + 38, self.rect.y + 15), 6)
...
def game_loop():
    ...
    while running:
        ...
        # Draw ocean floor
        pygame.draw.rect(screen, purple, (0, 450, 800, 150))  # Purple ocean floor
        ...
        if current_time - last_obstacle_time > OBSTACLE_INTERVAL:
            ...
            # Only create if less than 3 obstacles
            if len(obstacles) < 3:
                if obstacle_type == 1:
